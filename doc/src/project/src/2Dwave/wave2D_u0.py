...
def solver(I, V, f, c, Lx, Ly, Nx, Ny, dt, T,
    ...
    if version == 'cython':
        ...
        try:
            ...
            print 'No module wave2D_u0_par_loop_cy. Run make_wave2D_u0.sh!'
            print e
            sys.exit(1)
    elif version == 'numba':
        try:
        ...
        try:
            ...
            print 'No module wave2D_u0_loop_f77. Run make_wave2D_u0.sh!'
            sys.exit(1)
    elif version == 'c_f2py':
        try:
            ...
            print 'No module wave2D_u0_loop_c_f2py. Run make_wave2D_u0.sh!'
            sys.exit(1)
    elif version == 'pc_cy':
        try:
            ...
            print 'No module wave2D_u0_loop_c_cy. Run make_wave2D_u0.sh!'
            print e
            sys.exit(1)
